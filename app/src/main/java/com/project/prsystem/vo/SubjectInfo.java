package com.project.prsystem.vo;
...
public class SubjectInfo {
	...
	public String toString() {
		return  "{" + "\"subject\"" + ":" + "["
				+ "{" + "\"subj_code_div\""+":" + "\"" + getSubj_code_div() + "\"" + ","
				+ "\"curr_num\""+":"+ getCurr_num() + ","
				+ "\"subj_name\""+":" +"\"" +getSubj_name()+ "\"" + ","
				+ "\"subj_image\""+":" +"\"" +getSubj_image()+ "\"" + ","
				+ "\"subj_outline\""+":" +"\"" +getSubj_outline()+ "\"" + ","
				+ "\"limit_num\""+":" +getLimit_num()+ ","
				+ "\"year_term\""+":" +"\"" +getYear_term()+ "\"" + ","
				+ "\"prof_id\""+":"  +getProf_id() + ","
				+ "\"regist_code\""+":" +"\"" +getRegist_code() + "\""+ ","
				+ "\"subj_cre_date\""+":" +"\"" +getSubj_cre_date() + "\""+ ","
				+ "\"subj_mod_date\""+":" +"\"" +getSubj_mod_date() + "\""+ "}]}";
