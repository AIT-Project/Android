...
public class Notice {
	...
	public String toString() {
		return  "{" + "\"notice\"" + ":" + "["
				+ "{" + "\"noti_number\""+":" + getNoti_number()  + ","
				+ "\"noti_comment\""+":"+ "\"" +getNoti_comment()+ "\"" + ","
				+ "\"subj_code_div\""+":" +"\"" +getSubj_code_div()+ "\"" + ","
				+ "\"prof_id\""+":" +getProf_id() + ","
				+ "\"noti_cre_date\""+":" +"\"" +getNoti_cre_date()+ "\"" + ","
				+ "\"noti_mod_date\""+":" +"\"" +getNoti_mod_date()+ "\"" + ","
				+ "\"noti_name\""+":" +"\"" +getNoti_name()+ "\"" + ","
				+ "\"noti_del_date\""+":"  +getNoti_del()
				+ "}]}";
	}
