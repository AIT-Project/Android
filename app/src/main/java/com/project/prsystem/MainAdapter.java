...
public class MainAdapter extends BaseAdapter {
    ...
    // 분리하는게 좋다.
    public void addData(MainItem item) {
        data.add(item);
        notifyDataSetChanged();
    }

    public MainAdapter(ArrayList<MainItem> data, Context context, int layout) {
        this.data = data;
...
//            holder.TextCode =  (TextView)convertView.findViewById(R.id.TextCode);
            holder.noti_name =  (TextView)convertView.findViewById(R.id.noti_name);
        ...
        holder.noti_name.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.noti_name.setText(item.name);
